            ...
            <div className="ModalOpen">
                <div className="contenedor">
                    ...
                    <div className='ImageAndForm'>
                        <img className='LoginImg' src='https://res.cloudinary.com/dfprmjlir/image/upload/v1663006213/CANITAS%20RENTAL/pexels-trace-hudson-6056787_nt4gls.jpg' alt='LoginImg'></img>
